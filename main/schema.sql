...
(1, 'ODHR20210001', 1, 'Eleanor Vance', 'hr.eleanor@dayflow.com', 'password123', 'admin', 'Engineering', 'Chief Engineering HR Officer', '+1 (555) 019-2834', '742 Evergreen Terrace, Springfield, OR', '2021-03-15', 7500, 2500, 1500, 800, 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150&auto=format&fit=crop&q=80', 'approved', 1),
(2, 'ODHR20210002', 2, 'Marcus Vance', 'hr.marcus@dayflow.com', 'password123', 'admin', 'Product Design', 'Head of Design HR', '+1 (555) 342-9100', '101 Design Blvd, NY', '2021-05-10', 7400, 2400, 1400, 750, 'https://images.unsplash.com/photo-1560250097-0b93528c311a?w=150&auto=format&fit=crop&q=80', 'approved', 1),
(3, 'ODHR20220003', 3, 'Sophia Martinez', 'hr.sophia@dayflow.com', 'password123', 'admin', 'Marketing', 'Marketing HR Director', '+1 (555) 891-2345', '45 Market St, SF', '2022-01-15', 7200, 2300, 1300, 700, 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=150&auto=format&fit=crop&q=80', 'approved', 1),
(4, 'ODHR20220004', 4, 'David Kim', 'hr.david@dayflow.com', 'password123', 'admin', 'Sales & Finance', 'VP of Sales HR', '+1 (555) 456-7890', '88 Financial Plaza, Chicago, IL', '2022-04-01', 7600, 2600, 1600, 850, 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=150&auto=format&fit=crop&q=80', 'approved', 1);
...
('ODHR20210001', 1, '2026-08-22', '08:55 AM', '-', 'In Progress', 'Present'),
